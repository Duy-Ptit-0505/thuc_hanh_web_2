/** 289029912225019488 */ self.document = self;
self.window = self;
var ytcfg = {
  d: function () {
...
ytcfg.set({
  EXPERIMENT_FLAGS: {
    ...
    app_shell_asset_log_fraction: 1.0,
  ...
  INNERTUBE_CLIENT_VERSION: "2.20240422.01.00",
  INNERTUBE_CONTEXT: {
    client: {
      hl: "vi",
      gl: "VN",
  ...
  INNERTUBE_CONTEXT_CLIENT_VERSION: "2.20240422.01.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
  var policy = self.trustedTypes.createPolicy("youtubeServiceWorkerPolicy", {
    createScriptURL: function (unused) {
      return "https://www.youtube.com/s/desktop/70217e23/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js";
    },
  });
  importScripts(policy.createScriptURL(""));
} else {
  importScripts(
    "https://www.youtube.com/s/desktop/70217e23/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js"
  );
}
